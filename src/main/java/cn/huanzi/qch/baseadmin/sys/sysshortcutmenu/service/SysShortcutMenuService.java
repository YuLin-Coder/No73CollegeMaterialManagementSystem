...
public interface SysShortcutMenuService extends CommonService<SysShortcutMenuVo, SysShortcutMenu, Integer> {
    Result<List<SysShortcutMenuVo>> findByUserId(Integer userId);
}
