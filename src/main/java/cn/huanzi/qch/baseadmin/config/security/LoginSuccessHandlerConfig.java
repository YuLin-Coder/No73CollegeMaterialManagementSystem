...
public class LoginSuccessHandlerConfig implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Authentication authentication) throws IOException, ServletException {
        ...
        SysUserAuthority sysUserAuthority = sysUserAuthorityRepository.findByUserId(sysUserVo.getUserId()).get(0);
        SysAuthority one = sysAuthorityRepository.getOne(sysUserAuthority.getAuthorityId());
        sysUserVo.setRoleName(one.getAuthorityName());
        SysUserUtil.setSysUserMap(sysUserVo);
        //默认登陆成功
